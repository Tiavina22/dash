...
import { Search, Download, Github, Star, GitFork, Calendar, Siren as Fire, Code, Users, GitCommit } from 'lucide-react';
...
function App() {
  ...
  const fetchContributionData = async (username: string) => {
    try {
      ...
      const contributionsLastYear = response.user.contributionsCollection.totalCommitContributions;
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-center">{userData.public_repos}</div>
                    <div className="text-sm text-gray-400 text-center">Repositories</div>
                  </div>
                  ...
                  <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-center">{repoStats.stars}</div>
                    <div className="text-sm text-gray-400 text-center">Stars</div>
                  </div>
                  ...
                  <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-center">{repoStats.forks}</div>
                    <div className="text-sm text-gray-400 text-center">Forks</div>
                  </div>
                  ...
                  <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-center">{userData.followers}</div>
                    <div className="text-sm text-gray-400 text-center">Followers</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="text-sm text-gray-400 text-center">Total Contributions</div>
                  </div>
                  ...
                  <div className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="text-sm text-gray-400 text-center">Contributions (Last Year)</div>
                  </div>
                </div>
