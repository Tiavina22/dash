      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-4 mb-16">
            <Link
              to="/dashboard"
              className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity duration-200"
            >
              Commencer
            </Link>
            <a
              ...
              className="flex items-center bg-gray-800 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-700 transition-colors duration-200"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Langages utilisés</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Statistiques des dépôts</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Activité sociale</h3>
              <p className="text-gray-400">
